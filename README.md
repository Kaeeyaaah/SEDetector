...
2. .NET SDK (if you use Visual Studio, you can install the entire .NET framework within the app)
3. Tesseract (can be installed using the NuGet package installer in Visual Studio | Command: dotnet add package Tesseract)
